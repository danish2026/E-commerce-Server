...
import { PaymentStatus } from './create-purchase.dto';

export class PurchaseFilterDto {
  @ApiPropertyOptional({
    description: 'Free text search across supplier and buyer names',
    example: 'supplier',
  })
  @IsString()
  @IsOptional()
  ...
  @ApiPropertyOptional({
    description: 'Return purchases with dueDate on or after this date',
    example: '2024-01-01',
  })
  ...
  @ApiPropertyOptional({
    description: 'Return purchases with dueDate on or before this date',
    example: '2024-12-31',
  })
